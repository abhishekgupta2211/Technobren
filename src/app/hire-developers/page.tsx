      ...
      <section className="border-t border-ink-100 bg-white py-16 sm:py-24">
        <Container size="wide">
          <div className="relative overflow-hidden rounded-3xl border border-brand-200 bg-gradient-to-br from-brand-50 via-white to-brand-100/70 p-8 sm:p-14 lg:p-16 text-ink-950 shadow-xl text-center">
            ...
            <div
              aria-hidden
              className="pointer-events-none absolute -right-20 -top-20 size-96 rounded-full bg-brand-400/10 blur-3xl"
            />
            <div
              aria-hidden
              className="pointer-events-none absolute -left-20 -bottom-20 size-96 rounded-full bg-amber-400/10 blur-3xl"
            />

            <div className="relative max-w-3xl mx-auto flex flex-col items-center">
              <span className="inline-flex items-center gap-2 rounded-full border border-brand-200 bg-brand-100/70 px-4 py-1.5 font-mono text-xs font-bold text-brand-800 backdrop-blur-xs">
                <Star className="size-3.5 text-amber-500 fill-amber-500" /> Ready to Scale Your Engineering Capacity?
              </span>

              <h2 className="mt-6 font-display text-2xl font-extrabold sm:text-4xl lg:text-5xl text-ink-950 leading-tight">
                Get Pre-Vetted Developers Onboarded <span className="text-brand-700">in 48 Hours.</span>
              </h2>

              <p className="mt-4 text-sm sm:text-base text-ink-600 leading-relaxed max-w-xl">
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <Button href="#request-form" variant="primary" size="lg" arrow className="shadow-md">
                  Request Developers Now
                </Button>
              ...
              <p className="mt-8 text-xs font-medium text-ink-500">
